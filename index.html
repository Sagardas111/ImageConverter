				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<a href="index.html" class="logo"><strong>Online File Education</strong> by Sagar Das</a>
									<ul class="icons">
								...
								<section id="banner">
									<div class="content">
										<table width="500" align="center">
											<tr><td align="center">	<h2 align="center">Image Uploader & Converter by Theonlytutorials.com</h2></td></tr>
				...
				<!-- Sidebar -->
					<div id="sidebar">
						<div class="inner">
							...
							<!-- Menu -->
								<nav id="menu">
									...
									<ul>
										...
										<li>
											<span class="opener">Image Converter</span>
											<ul>
							...
							<!-- Footer -->
								<footer id="footer">
									<p class="copyright">&copy;2021 Online Image Converter </p>
								</footer>
